...
export class AuthManager {
    ...
    showApp(user) {
        ...
        // Show the main content (loading indicator should be hidden by main.js)
    ...
    async handleLogin(e) {
        ...
        try {
            ...
            if (result.success) {
                // Clear any existing userActive on login
                localStorage.removeItem('userActive');
                localStorage.removeItem('userFromBackOffice');
                console.log('Cleared userActive and userFromBackOffice on login');
                ...
                if (window.location.pathname.includes('login.html')) {
                    ...
                    if (isAdmin) {
                        ...
                        // Regular users go to personal area
                        window.location.href = 'personalArea.html';
                    }
                } else {
    ...
    clearViewedUser() {
        ...
        // Only set admin as the active user if we're not viewing another user
        if (adminUser && !this.getUserActive()) {
